<template>
  <div class="ai-recommendation-card relative group">
    ...
    <div class="absolute top-2 right-2 z-10">
      <div class="bg-black/70 backdrop-blur-sm text-white px-2 py-1 rounded-full text-xs font-bold flex items-center gap-1">
    ...
    >
      ...
      >
        <div class="text-center text-white">
          <!-- AI Icon -->
          <div class="w-16 h-16 bg-purple-600/80 rounded-full flex items-center justify-center mb-3 mx-auto animate-pulse">
