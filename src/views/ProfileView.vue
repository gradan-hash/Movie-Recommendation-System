<template>
  <div class="container mx-auto px-3 sm:px-4 py-4 sm:py-8">
    ...
    <div v-else class="max-w-4xl mx-auto">
      ...
      <div class="bg-gray-800 rounded-lg p-4 sm:p-6 mb-6 sm:mb-8">
        ...
        <div class="block sm:hidden">
          ...
          <div class="flex items-center gap-4 mb-4">
            <div class="relative">
              <div
                class="w-16 h-16 bg-red-500 rounded-full flex items-center justify-center text-lg font-bold text-white"
              >
                {{ userStore.userInitials }}
              </div>
              <button
                class="absolute -bottom-1 -right-1 bg-gray-700 rounded-full p-1.5 hover:bg-gray-600 transition-colors"
              >
                <svg
                ...
                >
                  <path
                    ...
                    stroke-width="2"
                    d="M15.232 5.232l3.536 3.536M9 13h3l8-8-3-3-8 8v3z"
                  ></path>
                </svg>
              </button>
            </div>
        ...
        <div class="hidden sm:flex items-center gap-6">
          ...
          <div class="relative">
            <div
              class="w-20 h-20 lg:w-24 lg:h-24 bg-red-500 rounded-full flex items-center justify-center text-xl lg:text-2xl font-bold text-white"
            >
              {{ userStore.userInitials }}
            </div>
            <button
              class="absolute bottom-0 right-0 bg-gray-700 rounded-full p-2 hover:bg-gray-600 transition-colors"
            >
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 sm:gap-6 mb-6 sm:mb-8">
        <div class="bg-gray-800 rounded-lg p-4 sm:p-6 text-center">
          <div class="text-2xl sm:text-3xl font-bold text-red-400 mb-1 sm:mb-2">
      ...
      <div v-if="movieStats" class="bg-gray-800 rounded-lg p-4 sm:p-6 mb-6 sm:mb-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
          ...
          <div>
            ...
            <div class="space-y-2">
              <div
                v-for="[genreId, count] in movieStats.favoriteGenres"
                :key="genreId"
          ...
          <div>
            ...
            <div class="space-y-2">
              <div
                v-for="[year, count] in movieStats.favoriteYears"
                :key="year"
                class="flex justify-between items-center text-sm"
              >
      ...
      <div class="bg-gray-800 rounded-lg p-4 sm:p-6">
        ...
        <div
          ...
          class="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-6 gap-2 sm:gap-4"
        >
          <div
          ...
          >
            ...
            />
            <div
              class="absolute inset-0 bg-black/0 group-hover:bg-black/70 transition-colors rounded-lg flex items-center justify-center"
            >
              <div
                class="text-white opacity-0 group-hover:opacity-100 transition-opacity text-center p-1 sm:p-2"
              >
                <h3 class="font-semibold text-xs sm:text-sm mb-1 line-clamp-2">
                  {{ movie.title }}
                </h3>
        ...
        <div v-else class="text-center py-8 sm:py-12">
          ...
          <p class="text-gray-400 mb-4 text-sm sm:text-base">
            Start exploring and like movies to build your profile
          </p>
          <router-link
            to="/"
    ...
    >
      <div class="bg-gray-800 rounded-lg max-w-md w-full p-4 sm:p-6 mx-auto" @click.stop>
        <div class="flex justify-between items-center mb-4 sm:mb-6">
...
const viewMovieDetails = (_movie: Movie) => {
